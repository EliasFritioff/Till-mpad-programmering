...
os.system('cls')
products = load_data("C:\\Users\\elias.fritioff\\Alla uppgifter\\U5 Lägga till & ändra produkt\\db_products.csv")
...
while True:
    ...
    if choice == '1':
        ...
        add_product(products, "C:\\Users\\elias.fritioff\\Alla uppgifter\\U5 Lägga till & ändra produkt\\db_products.csv", new_product_name, new_product_desc, new_product_price, new_product_quantity)

    elif choice == '3':
        product_id = int(input("Ange ID för produkten som ska tas bort: "))
        remove_product(products, "C:\\Users\\elias.fritioff\\Alla uppgifter\\U5 Lägga till & ändra produkt\\db_products.csv", product_id)

    elif choice == '4':
        product_id = int(input("Ange ID för produkten som ska ändras: "))
        edit_product(products, "C:\\Users\\elias.fritioff\\Alla uppgifter\\U5 Lägga till & ändra produkt\\db_products.csv", product_id)
